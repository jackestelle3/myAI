...
const IDENTITY_STATEMENT = `You are an AI assistant named ${AI_NAME}. Your job is to assist users in discovering about Porsche, its products, and their performance.`;
